                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div class="md:col-span-2">
                            <input v-model="code_filter" type="text" class="input input-bordered w-full" placeholder="Codigo">
                        </div>
                        ...
                        <div class="md:col-span-3">
                            <input v-model="name_filter" type="text" class="input input-bordered w-full" placeholder="Nombre">
                        </div>
                      
                        <button @click="fetchList()" class="btn btn-soft btn-primary md:col-span-1"><i class="material-icons text-3xl">search</i> Buscar</button>
